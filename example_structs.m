...
if nargin < 1
    ...
    timings = struct(   'trainfreq', {{4,2}, 3, {5, 1}, 4}, ...
                        'traindur', {{1,5}, 5, {1, 10}, 4}, ...
                        'offsets', {{110, 120}, 300, {200, 250}, 400}, ...
                        'template', {{[], []}, [], {[], []}, []});

    % Defines shapes and train timings of pulses
    shapes = struct(    'modes', {{'rect', 'sine'}, 'rampUp', {'triang', 'trapez'}, 'rampDown'}, ...
                        'Vvals', {{3, 1}, 2, {1, 5}, 4}, ...
                        'pulsefreq', {{0, 25}, 0, {0, 0}, 0}, ...
                        'pulsedur', {{100, 200}, 100, {100, [150 400 100]}, 100}, ...
                        'template', {{3, []}, [], {[], []}, []}); 
